...
<body>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="dropdown me-3">
                                <button class="btn btn-outline-primary dropdown-toggle" type="button"
                                    id="periodoDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-outline-secondary dropdown-toggle"
                                            type="button" id="dropdownPeriodo" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            Último periodo
                                        </button>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card dashboard-card">
                                <div
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-outline-secondary dropdown-toggle"
                                            type="button" id="dropdownCalificaciones" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            Periodo actual
                                        </button>
    ...
    <script src="{{ asset('dashboard-interactivo.js') }}"></script>
