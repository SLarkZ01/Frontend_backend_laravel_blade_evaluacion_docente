...
// Verifica si hay datos antes de enviarlo
   ...
   // Verifica si hay datos antes de enviarlo
    ...
    return view('Decano.index', compact('total_docentes','totalNoEvaluados','totalEstudiantesNoEvaluaron','promedio_global_p','promedios', 'labels', 'notas','docentes','docentesUnicos'));
    }
